...
// ("Halftone"). Zero dependencies: one WebGL
...
const UNIFORMS = {
  colors: [[0.23137254901960785,0.5098039215686274,0.9647058823529412],[0.1450980392156863,0.38823529411764707,0.9215686274509803],[0.11372549019607843,0.3058823529411765,0.8470588235294118],[0.11764705882352941,0.25098039215686274,0.6862745098039216],[0.11764705882352941,0.22745098039215686,0.5411764705882353],[0.11764705882352941,0.22745098039215686,0.5411764705882353],[0.11764705882352941,0.22745098039215686,0.5411764705882353],[0.11764705882352941,0.22745098039215686,0.5411764705882353]] as [number, number, number][],
  colorCount: 5,
  scale: 1.780,
  intensity: 0.190,
  paramA: 1.000,
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const timeAnimated = !reducedMotion && Math.abs(UNIFORMS.timeScale) > 0.0001
    ...
    function render(now: number) {
      ...
      gl.uniform4f(
        ...
        width,
        height,
        reducedMotion ? 0 : ((now - start) / 1000) * UNIFORMS.timeScale,
        UNIFORMS.colorCount,
      )
      gl.uniform4f(
        uni.space,
  ...
  return (
    <canvas aria-hidden="true" ref={canvasRef} className={className} style={{ display: "block", width: "100%", height: "100%" }} />
  )
}
